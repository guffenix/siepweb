...
<div id="ayuda1" class="alert alert-success collapse">
  ...
  <div class="form-group" id="namePro">
    <label for="n2">2.2. Identificación, descripción y diagnóstico del problema:
...
<strong>Ayuda: </strong>En esta sección debe realizar bla bla bla...
  ...
  <div class="form-group" id="namePro">
    ...
    <textarea type="text" class="form-control" id="n3">
    </textarea>
  </div>

  <p><b>2.4. Análisis de Oferta y Demanda:</b></p>
  <div class="panel panel-default">
    ...
    <strong>Ayuda: </strong>En esta sección debe realizar bla bla bla...
      ...
      <input type="number" placeholder="valor numerico" min="0" class="form-control">
	    <textarea type="text" class="form-control" id="aod-dmdef">
	    </textarea>
	  </div>
    ...
    <strong>Ayuda: </strong>En esta sección debe realizar bla bla bla...
      ...
      <input type="number" placeholder="valor numerico" min="0" class="form-control">
	    <textarea type="text" class="form-control" id="aod-oferta">
	    </textarea>
	  </div>
