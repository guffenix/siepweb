...
background: -moz-linear-gradient(top, rgba(50,50,80,1) 0%, rgba(50,50,80,1) 50%, rgba(255,255,255,1) 100%);
background: -webkit-gradient(left top, left bottom, color-stop(0%, rgba(50,50,80,1)), color-stop(50%, rgba(50,50,80,1)), color-stop(100%, rgba(255,255,255,1)));
background: -webkit-linear-gradient(top, rgba(50,50,80,1) 0%, rgba(50,50,80,1) 50%, rgba(255,255,255,1) 100%);
background: -o-linear-gradient(top, rgba(50,50,80,1) 0%, rgba(50,50,80,1) 50%, rgba(255,255,255,1) 100%);
background: -ms-linear-gradient(top, rgba(50,50,80,1) 0%, rgba(50,50,80,1) 50%, rgba(255,255,255,1) 100%);
background: linear-gradient(to bottom, rgba(50,50,80,1) 0%, rgba(50,50,80,1) 50%, rgba(255,255,255,1) 100%);
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#323250', endColorstr='#ffffff', GradientType=0 );
    ...
    .imagenSelected:hover{
      ...
      cursor: pointer;
      padding: 5px;
     background-image: url('recursos/images/fondoSeleccion.png');
      border-radius: 10px 10px;
      -moz-box-shadow: 0 0px 10px rgb(50,150,255);
      -webkit-box-shadow: 0 0px 10px rgb(50,150,255);
      box-shadow: 0 0px 10px rgb(50,150,255);
